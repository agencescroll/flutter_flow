...
class _$ReviewsRecord extends ReviewsRecord {
  ...
  _$ReviewsRecord._({this.title, this.description, this.ref, this.ffRef})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, title.hashCode), description.hashCode), ref.hashCode),
        ffRef.hashCode));
  }
  ...
  _$ReviewsRecord _build() {
    final _$result = _$v ??
        new _$ReviewsRecord._(
            title: title, description: description, ref: ref, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
